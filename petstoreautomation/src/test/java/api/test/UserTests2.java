...
public class UserTests2 {
	...
	// generate data using Faker library and the data is passed to POJO class and data we will pass along with POST request
	public void setUp() {
		faker = new Faker();
	...
	// posting the data that are generated using setUpData()
	@Test(priority = 1)
